...
public class TestGenericRecordAvroDeserializer extends GenericRecordAvroDeserializer {

    private final TestSchemaRegistry registry;

    public TestGenericRecordAvroDeserializer(TestSchemaRegistry registry) {
