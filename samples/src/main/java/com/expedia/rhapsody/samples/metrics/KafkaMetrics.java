 ...
 */
package com.expedia.rhapsody.samples.metrics;
...
import com.expedia.rhapsody.core.transformer.MetricsConfig;
import com.expedia.rhapsody.core.transformer.MetricsTransformer;
...
import com.expedia.rhapsody.kafka.metrics.ReactiveStreamsMetricsReporter;
    ...
    public static void main(String[] args) throws Exception {
        ...
        new KafkaValueFluxFactory<String>(kafkaPublisherConfig)
            ...
            .transform(upperCasedValues -> new KafkaValueSenderFactory<String>(kafkaSubscriberConfig)
                .sendAcknowledgeableValues(upperCasedValues, value -> TOPIC_2, Function.identity()))
