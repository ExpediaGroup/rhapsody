 ...
 */
package com.expedia.rhapsody.samples.infrastructuralinteroperability;
...
import com.expedia.rhapsody.rabbitmq.serde.BodyDeserializer;
import com.expedia.rhapsody.rabbitmq.serde.BodySerializer;
import com.expedia.rhapsody.rabbitmq.serde.JacksonBodyDeserializer;
import com.expedia.rhapsody.rabbitmq.serde.JacksonBodySerializer;
...
public class RabbitmqToKafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new RabbitMQBodyFluxFactory<String>(rabbitConfigFactory)
            ...
            .transform(upperCasedValues -> new KafkaValueSenderFactory<String>(kafkaSubscriberConfig)
                .sendAcknowledgeableValues(upperCasedValues, value -> TOPIC, Function.identity()))
