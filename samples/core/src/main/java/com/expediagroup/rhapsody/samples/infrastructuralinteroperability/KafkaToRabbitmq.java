...
public class KafkaToRabbitmq {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new KafkaValueFluxFactory<String>(kafkaPublisherConfig)
            ...
            .transform(new RabbitMQBodySenderFactory<String>(rabbitConfigFactory)
                .sendAcknowledgeableBodies(DefaultRabbitMessageCreator.persistentBasicToDefaultExchange(QUEUE)))
