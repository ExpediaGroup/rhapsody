...
rhapsody `0.5.16` is a beta release containing updates outlined below

### Fixes

* Downgrade Reactor to v3.4.1 due to apparent groupBy bug

## [0.5.15]

rhapsody `0.5.15` is a beta release containing updates outlined below

### Changes

* `max.in.flight` configurations for Kafka have been renamed for clarity (#132)

## [0.5.14]

rhapsody `0.5.14` is a beta release containing updates outlined below

### Changes

* Upgraded to latest version (3.4.6) of Reactor (#125)
